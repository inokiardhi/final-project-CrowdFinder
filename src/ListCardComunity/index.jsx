                    ...
                    <div className="user-detail d-flex ms-1 ">
                        <div className="image">
                            {userbyid.following?.filter((item) => item.role === "community").map((item) => item.image === null) ?
                                (<img src={`https://ui-avatars.com/api/?name=${props.comunityname}&background=random&length=1&rounded=true&size=35`} />) : (<img src={`https://crowdfinder.gabatch13.my.id/api${props.photo}`} />)}
                        </div>
